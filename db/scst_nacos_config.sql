...
) ENGINE=InnoDB AUTO_INCREMENT=30 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='config_info';
...
INSERT INTO `config_info` VALUES (7, 'scst-gateway-dev.yml', 'DEFAULT_GROUP', 'spring:\n  cloud:\n    gateway:\n      discovery:\n        locator:\n          enabled: true\n      routes:\n        # `scst-auth`服务路由\n        - id: scst-auth\n          uri: lb://scst-auth\n          predicates:\n            - Path=/auth/**\n          filters:\n             - StripPrefix=1\n        # `scst-system`服务路由\n        - id: scst-system-biz\n          uri: lb://scst-system-biz\n          predicates:\n            - Path=/admin/**\n          filters:\n             - StripPrefix=1\n', '9257a8e7b1ad6dbb22fd482b63a84183', '2020-07-12 00:11:58', '2020-07-13 11:23:42', NULL, '0:0:0:0:0:0:0:1', '', '', '`scst-gateway` 网关服务配置', '', '', 'yaml', '');
...
CREATE TABLE `his_config_info` (
  ...
  KEY `idx_did` (`data_id`)
) ENGINE=InnoDB AUTO_INCREMENT=29 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='多租户改造';
