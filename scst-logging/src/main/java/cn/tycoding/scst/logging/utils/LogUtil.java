...
public class LogUtil {
    ...
    public static StringBuilder handlerParams(StringBuilder params, Object[] args, List<String> paramNames, ObjectMapper objectMapper) throws JsonProcessingException {
        for (int i = 0; i < args.length; i++) {
            if (args[i] instanceof Map) {
                ...
                return handlerParams(params, list.toArray(), paramList, objectMapper);
            } else {
